    ...
    <main className="min-h-[100vh] relative overflow-hidden flex flex-col -mt-20 md:-mt-[84px]">
      ...
      <div className="hidden md:block absolute inset-0 w-full h-full z-0">
        ...
        {lottieData && (
          <motion.div
            ...
            className="absolute inset-x-0 bottom-0 w-full z-0 pointer-events-none bg-bottom opacity-100"
          >
            <Lottie
      ...
      <div className="relative z-10 flex-1 flex-col">
        ...
        <div className="bottom-12 w-full flex justify-center">
          ...
          >
            <a href="https://app.zpass.ai/" target="_blank" rel="noopener noreferrer">
              <Button
                size="lg"
